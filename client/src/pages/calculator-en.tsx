            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900">How much capital do you need for $1,000/month in dividends?</h3>
                    <p className="text-sm text-gray-600">Try our Goal Calculator</p>
                  </div>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900">When will dividends start rolling on their own?</h3>
                    <p className="text-sm text-gray-600">Try the Snowball Simulator</p>
                  </div>
                </div>
